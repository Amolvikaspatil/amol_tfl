...
object ReadFromKafka {
  def main(args: Array[String]): Unit = {
    ...
    //df.writeStream.format("csv").option("checkpointLocation", "/tmp/jenkins/kafka/trainarrival/checkpoint").option("path", "/tmp/jenkins/kafka/trainarrival/data/tfl_u").start().awaitTermination()
  }
